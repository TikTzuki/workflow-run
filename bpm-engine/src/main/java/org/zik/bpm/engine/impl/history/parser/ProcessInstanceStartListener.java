...
{
    public ProcessInstanceStartListener(final HistoryEventProducer historyEventProducer) {
    ...
    protected HistoryEvent createHistoryEvent(final DelegateExecution execution) {
        ...
        if (this.historyLevel.isHistoryEventProduced(HistoryEventTypes.PROCESS_INSTANCE_START, execution)) {
