...
public class CreateMembershipCmd extends AbstractWritableIdentityServiceCmd<Void> implements Command<Void>, Serializable
{
    ...
    public CreateMembershipCmd(final String userId, final String groupId) {
        this.userId = userId;
    ...
    protected Void executeCmd(final CommandContext commandContext) {
        ...
        final IdentityOperationResult operationResult = commandContext.getWritableIdentityProvider().createMembership(this.userId, this.groupId);
