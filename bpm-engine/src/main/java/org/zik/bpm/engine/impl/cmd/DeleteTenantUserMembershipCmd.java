...
public class DeleteTenantUserMembershipCmd extends AbstractWritableIdentityServiceCmd<Void> implements Command<Void>, Serializable
{
    ...
    public DeleteTenantUserMembershipCmd(final String tenantId, final String userId) {
    ...
    protected Void executeCmd(final CommandContext commandContext) {
        ...
        final IdentityOperationResult operationResult = commandContext.getWritableIdentityProvider().deleteTenantUserMembership(this.tenantId, this.userId);
