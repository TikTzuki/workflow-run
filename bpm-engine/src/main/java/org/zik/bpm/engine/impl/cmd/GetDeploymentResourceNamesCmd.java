...
public class GetDeploymentResourceNamesCmd implements Command<List>, Serializable
{
    ...
    public GetDeploymentResourceNamesCmd(final String deploymentId) {
    ...
    public List execute(final CommandContext commandContext) {
        ...
        return Context.getCommandContext().getDeploymentManager().getDeploymentResourceNames(this.deploymentId);
    }
}
