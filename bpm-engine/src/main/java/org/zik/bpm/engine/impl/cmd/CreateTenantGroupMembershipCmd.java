...
public class CreateTenantGroupMembershipCmd extends AbstractWritableIdentityServiceCmd<Void> implements Command<Void>, Serializable
{
    ...
    public CreateTenantGroupMembershipCmd(final String tenantId, final String groupId) {
    ...
    protected Void executeCmd(final CommandContext commandContext) {
        ...
        final IdentityOperationResult operationResult = commandContext.getWritableIdentityProvider().createTenantGroupMembership(this.tenantId, this.groupId);
