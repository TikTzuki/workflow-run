...
public class ReenableCaseExecutionCmd extends StateTransitionCaseExecutionCmd
{
    ...
    public ReenableCaseExecutionCmd(final String caseExecutionId, final Map<String, Object> variables, final Map<String, Object> variablesLocal, final Collection<String> variableDeletions, final Collection<String> variableLocalDeletions) {
        super(caseExecutionId, variables, variablesLocal, variableDeletions, variableLocalDeletions);
    }
    
    public ReenableCaseExecutionCmd(final CaseExecutionCommandBuilderImpl builder) {
        super(builder);
    }
