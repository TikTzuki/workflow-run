...
public abstract class AddIdentityLinkCmd implements Command<Void>, Serializable
{
    ...
    public AddIdentityLinkCmd(final String taskId, final String userId, final String groupId, final String type) {
    ...
    protected void checkAddIdentityLink(final TaskEntity task, final CommandContext commandContext) {
