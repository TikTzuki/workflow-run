...
public class GetDeploymentProcessDiagramCmd implements Command<InputStream>, Serializable
{
    ...
    public GetDeploymentProcessDiagramCmd(final String processDefinitionId) {
    ...
    public InputStream execute(final CommandContext commandContext) {
        ...
        final InputStream processDiagramStream = commandContext.runWithoutAuthorization((Command<InputStream>)new GetDeploymentResourceCmd(deploymentId, resourceName));
