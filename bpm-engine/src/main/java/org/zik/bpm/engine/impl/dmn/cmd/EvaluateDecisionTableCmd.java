...
public class EvaluateDecisionTableCmd implements Command<DmnDecisionTableResult>
{
    ...
    public EvaluateDecisionTableCmd(final DecisionTableEvaluationBuilderImpl builder) {
    ...
    @Override
    public DmnDecisionTableResult execute(final CommandContext commandContext) {
    ...
    protected DmnDecisionTableResult doEvaluateDecision(final DecisionDefinition decisionDefinition, final VariableMap variables) {
        try {
