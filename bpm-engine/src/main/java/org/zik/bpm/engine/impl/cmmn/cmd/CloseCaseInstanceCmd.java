...
public class CloseCaseInstanceCmd extends StateTransitionCaseExecutionCmd
{
    ...
    public CloseCaseInstanceCmd(final CaseExecutionCommandBuilderImpl builder) {
        super(builder);
    }
    
    public CloseCaseInstanceCmd(final String caseExecutionId, final Map<String, Object> variables, final Map<String, Object> variablesLocal, final Collection<String> variableDeletions, final Collection<String> variableLocalDeletions) {
